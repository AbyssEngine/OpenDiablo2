...
return {
    ...
    Palette = {
        ...
        Act4 = "PaletteAct4",
        Act5 = "PaletteAct5",
        EndGame = "PaletteEndGame",
        EndGame2 = "PaletteEndGame2",
        Fechar = "PaletteFechar",
        ...
        Menu4 = "PaletteMenu4",
        Sky = "PaletteSky",
        Static = "PaletteStatic",
        Trademark = "PaletteTrademark",
        Units = "PaletteUnits"

    },

    Palettes = {{"PaletteAct1", "/data/global/palette/act1/pal.pl2"},
                {"PaletteAct2", "/data/global/palette/act2/pal.pl2"},
                {"PaletteAct3", "/data/global/palette/act3/pal.pl2"},
                {"PaletteAct4", "/data/global/palette/act4/pal.pl2"},
                {"PaletteAct5", "/data/global/palette/act5/pal.pl2"},
