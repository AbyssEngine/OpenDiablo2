...
function LoadGlobals()
    ...
    local function loadFormal(size)
        ...
        return abyss.createTtfFont("Philosopher", '/data/hd/ui/fonts/philosopher-bolditalic.ttf', math.floor(size * 1.2), 'slight')
    end
    local function loadFnt(size)
        ...
        SpriteFontIsActuallyTTF = true
        return abyss.createTtfFont("Exocet Blizzard Mixed Caps", '/data/hd/ui/fonts/ExocetBlizzardOT-Medium.otf', math.floor(size * 0.8), 'none')
    end
    local function loadExocet(size)
        ...
        SpriteFontIsActuallyTTF = true
        return abyss.createTtfFont("Exocet Blizzard Mixed Caps", '/data/hd/ui/fonts/ExocetBlizzardOT-Medium.otf', math.floor(size * 1.4), 'none')
    end
    local function loadSucker()
        ...
        SpriteFontIsActuallyTTF = true
        return abyss.createTtfFont("BlizzardGlobal", '/data/hd/ui/fonts/BlizzardGlobal-v5_81.ttf', 10, 'none')
        --return abyss.createTtfFont("BlizzardGlobalTCUnicode", '/data/hd/ui/fonts/BlizzardGlobalTCUnicode.ttf', 8, 'none')
    end
    local function loadRidiculous()
        ...
        SpriteFontIsActuallyTTF = true
        return abyss.createTtfFont("Exocet Blizzard Mixed Caps", '/data/hd/ui/fonts/ExocetBlizzardOT-Medium.otf', 10, 'none')
    end
